...
To modify the pipelines for `ai-gateway-payload-processing` in the `rhoai-3.6-ea.1` release:
...
```bash
git commit -am "Update pipelinerun for ai-gateway-payload-processing (rhoai-3.6-ea.1)"
