...
import (
	...
	profile_picker "github.com/opendatahub-io/ai-gateway-payload-processing/pkg/plugins/passthrough-profile-picker"
...
func RegisterPlugins() {
	...
	plugin.Register(profile_picker.PassthroughProfilePickerType, profile_picker.Factory)
}
